  ...
  return (
    ...
    >
      <div className="text-center">
        <h5>
          ...
          <a
            ...
            style={{ textDecoration: "none", color: "cayn" }}
          >
            Vinay Maggidi❤
          </a>
        </h5>
      ...
      <div className="text-center pt-1">
        <a
          href="https://www.linkedin.com/in/vinaymaggidi1333/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://github.com/victoryanonymous"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="mailto:vinaymaggidii@gmail.com"
          target="_blank"
          rel="noreferrer"
        >
          <i
